...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_applicant', (
            ...
            ('dateofbird', self.gf('django.db.models.fields.DateField')()),
            ('bio', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=40)),
            ('jabber', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('skype', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, blank=True)),
    ...
    models = {
        u'hello.applicant': {
            ...
            'jabber': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
